...
class FinanlyCLI:
    ...
    def main_menu(self):
        ...
        banner(f"finanly - Usuário: {user.nome}")
    ...
    def profile_menu(self):
        # Protege contra `current_user()` retornando None
        if self.app.current_user() is None:
            print(color("Faça login para ver o perfil.", C.RED))
            pause()
            return
    ...
    def groups_menu(self):
        if self.app.current_user() is None:
            print(color("Faça login para acessar os grupos.", C.RED))
            pause()
            return
    ...
    def expenses_menu(self):
        if self.app.current_user() is None:
            print(color("Faça login para acessar as despesas.", C.RED))
            pause()
            return
    ...
    def payments_menu(self):
        if self.app.current_user() is None:
            print(color("Faça login para acessar os pagamentos.", C.RED))
            pause()
            return
    ...
    def reports_menu(self):
        if self.app.current_user() is None:
            print(color("Faça login para acessar relatórios.", C.RED))
            pause()
            return
    ...
    def choose_group_and_payer(self) -> Tuple[int, int]:
        if self.app.current_user() is None:
            print(color("Faça login para selecionar grupo e pagador.", C.RED))
            pause()
            raise ValueError("Login necessário")
