...
TEST_DATA = "finanly_test_data.json"
...
def setup_test_data():
    base = {
        ...
        "expenses": [],
        "payments": [],
        "categories": finanly_pro.FinanlySystem.DEFAULT_CATEGORIES,
        "counters": {
            "next_user_id": 1,
            "next_group_id": 1,
            "next_expense_id": 1,
...
def run_tests():
    ...
    finanly_pro.DATA_FILE = TEST_DATA
    ...
    item = finanly_pro.ExpenseItem(nome="X", valor=50.0, categoria="Outros", allocations=[finanly_pro.ItemAllocation(user_id=u1.user_id, amount=30.0), finanly_pro.ItemAllocation(user_id=u2.user_id, amount=10.0)])
    try:
